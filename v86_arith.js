...
{
    //if(this.safe_read32s(this.mem_eip + 1) === 0 && this.safe_read32s(this.mem_eip + 5) === 0) throw "0000000";
...
{
    var result = source_operand * this.getReg8(reg_eax);//this.reg8[reg_al];
...
{
    var result = source_operand * this.getReg8s(reg_eax);//this.reg8s[reg_al];
...
{
    var result = source_operand * this.getReg16(reg_eax),//this.reg16[reg_ax],
...
{
    var dest_operand = this.getReg32s(reg_eax);

    var result = this.do_mul32(dest_operand, source_operand);

    this.setReg32s(reg_eax, result[0]);//this.reg32s[reg_eax] = result[0];
    this.setReg32s(reg_edx, result[1]);//this.reg32s[reg_edx] = result[1];
...
CPU.prototype.imul32 = function(source_operand)
{
    ...
    var dest_operand = this.getReg32s(reg_eax);//this.reg32s[reg_eax];
...
CPU.prototype.div8 = function(source_operand)
{
    ...
    var target_operand = this.getReg16(reg_eax),//this.reg16[reg_ax],
    ...
    {
        this.setReg16(reg_eax, result | ((target_operand % source_operand) << 8));
...
CPU.prototype.idiv8 = function(source_operand)
{
    ...
    var target_operand = this.getReg16s(reg_eax),//this.reg16s[reg_ax],
        result = target_operand / source_operand | 0;
...
CPU.prototype.div16 = function(source_operand)
{
    ...
    {
        this.setReg16(reg_eax, result);//this.reg16[reg_ax] = result;
        this.setReg16(reg_edx, target_operand % source_operand);//this.reg16[reg_dx] = target_operand % source_operand;
    }
};
...
CPU.prototype.idiv16 = function(source_operand)
{
    ...
    var target_operand = this.getReg16(reg_eax) | (this.getReg16(reg_edx) << 16),//this.reg16[reg_ax] | (this.reg16[reg_dx] << 16),
        result = target_operand / source_operand | 0;
...
CPU.prototype.div32 = function(source_operand)
{
    ...
    var dest_operand_low = this.getReg32(reg_eax),//this.reg32[reg_eax],
        dest_operand_high = this.getReg32(reg_edx);//this.reg32[reg_edx];
    ...
    {
        this.setReg32s(reg_eax, result);//this.reg32s[reg_eax] = result;
        this.setReg32s(reg_edx, mod);//this.reg32s[reg_edx] = mod;
    }
...
CPU.prototype.idiv32 = function(source_operand)
{
    ...
    var dest_operand_low = this.getReg32(reg_eax),//this.reg32[reg_eax],
        dest_operand_high = this.getReg32s(reg_edx),//this.reg32s[reg_edx],
        div_is_neg = false,
        is_neg = false;
